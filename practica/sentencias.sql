...
CREATE TABLE IF NOT EXISTS libros (
	...
	fecha_creacion DATETIME DEFAULT current_timestamp,
	FOREIGN KEY(autor_id) REFERENCES autores(autor_id) ON DELETE CASCADE -- ON DELETE NO ACTION
);
...
INSERT INTO autores (nombre, apellido, pseudonimo, fecha_nacimiento, genero, pais_origen )
...
VALUES  ('Eduardo', 'García', 'eduardogpg', 'eduardo@dominio.com'),
        ('Armando', 'Rivera', 'Army', 'armando@dominio.com'),
        ('Juan', 'Gonzalez', 'Jhon', 'juan@dominio.com'),
        ('Pedro', 'Hernandez', 'Peter', 'pedrin@dominio.com');

INSERT INTO libros_usuarios(libro_id, usuario_id)
/* El primer valor es el libro_id y el segundo es el usuario_id */
VALUES  (1, 1), (2, 1), (3, 1),
        (55, 3), (55, 3), (55, 3);
